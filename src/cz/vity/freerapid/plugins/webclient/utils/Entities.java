...
final class Entities {
    ...
    static final String[][] ISO8859_1_ARRAY = {{"nbsp", "160"}, // non-breaking space
            ...
            {"oslash", "248"}, // ?owercase o, slash
            {"ugrave", "249"}, // ?owercase u, grave accent
            {"uacute", "250"}, // ?owercase u, acute accent
            {"ucirc", "251"}, // ?owercase u, circumflex accent
            {"uuml", "252"}, // ?wercase u, umlaut
            {"yacute", "253"}, // ?wercase y, acute accent
            {"thorn", "254"}, // ?wercase thorn, Icelandic
            {"yuml", "255"}, // ?wercase y, umlaut
    };
