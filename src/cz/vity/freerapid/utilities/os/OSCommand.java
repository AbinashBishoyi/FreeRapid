...
public enum OSCommand {
    CREATE_DESKTOP_SHORTCUT, CREATE_STARTMENU_SHORTCUT, CREATE_STARTUP_SHORTCUT, CREATE_QUICKLAUNCH_SHORTCUT, HIBERNATE, SHUTDOWN, REBOOT, STANDBY, RESTART_APPLICATION;
