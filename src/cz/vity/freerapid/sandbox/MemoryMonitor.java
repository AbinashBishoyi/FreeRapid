...
public class MemoryMonitor extends JPanel {
    ...
    public class Surface extends JPanel implements Runnable {
        ...
        public void paint(Graphics g) {
            ...
            float freeMemory = (float) r.nextDouble() * 40;
            float totalMemory = (float) r.nextDouble() * 50;
            if (totalMemory > max) {
                max = totalMemory;
                pts = null;
            } else {
            ...
            big.setColor(GREEN);
            big.drawString(String.valueOf(totalMemory + "KB/s"), 4.0f, (float) ascent + 0.5f);
            usedStr = String.valueOf(freeMemory) + "KB/s average";
